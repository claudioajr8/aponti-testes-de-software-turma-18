...
- Criar um README organizado.
- Praticar a linguagem Markdown.
...
1. Aprender Git.
2. Dominar GitHub.
3. Criar projetos pessoais.
4. Montar um portfólio.
...
## 📊 Tabela de aprendizado (Opcional)
...
📧 Email: claudio.albuquerquej@ufpe.br
